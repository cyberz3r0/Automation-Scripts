...
schedule.every().monday.at("11:00", "America/Los_Angeles").do(timesheet)
...
schedule.every().monday.at("14:00", "America/Los_Angeles").do(timesheet)
...
schedule.every().monday.at("15:00", "America/Los_Angeles").do(timesheet)
...
schedule.every().monday.at("20:00", "America/Los_Angeles").do(timesheet)
